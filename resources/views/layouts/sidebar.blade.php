                        ...
                        <ul class="metismenu list-unstyled" id="side-menu" style="background-color: #13395d !important;">
                            ...
                            <li style="background-color: #13395d !important;">
                                ...
                                <ul class="sub-menu" aria-expanded="true" style="background-color: #13395d !important;">
                                    ...
                                    <li style="background-color: #13395d !important;"><a href="{{ route('others.admin-requests') }}" style="color: white !important; background-color: #13395d !important; padding: 8px 20px 8px 40px; display: block;">Admin Requests</a></li>
                                </ul>
                            </li>
                            @endif
