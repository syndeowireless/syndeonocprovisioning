...
<div class="bg-white rounded-3xl border-2 border-slate-200 p-10 max-w-5xl w-full mx-auto shadow-lg">
    ...
    <div class="flex flex-col lg:flex-row gap-0 mb-10 items-stretch">
        ...
        <div class="hidden lg:block w-px bg-slate-300 my-2"></div>
        <div class="block lg:hidden h-px bg-slate-300 mx-0"></div>
        <!-- DAS Master Unit IPs -->
        <div class="flex-1 flex flex-col justify-between min-h-[300px] py-8 px-6">
