...
@section('content')
<div class="bg-white rounded-3xl border-2 border-slate-200 p-10 max-w-7xl w-full mx-auto shadow-lg">
    <h1 class="text-3xl font-bold text-slate-500 mb-10 tracking-wide">ALEXANDER HOTEL</h1>
    <div class="flex flex-col md:flex-row md:space-x-0 mb-10 items-stretch">
        <!-- Segment 1 -->
        <div class="flex-1 min-w-0 flex flex-col justify-between py-8 px-4">
            ...
            <div class="flex items-center gap-5 mb-8 flex-grow">
                <div class="shrink-0">
                    <!-- SVG Icon -->
                    <svg width="60" height="60" fill="none"><path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2Z" stroke="#2563eb" stroke-width="2" fill="#e0f2fe"/><path d="M14 2V8H20" stroke="#2563eb" stroke-width="2" fill="none"/><path d="M16 13H8" stroke="#2563eb" stroke-width="1.5"/><path d="M16 17H8" stroke="#2563eb" stroke-width="1.5"/><path d="M10 9H8" stroke="#2563eb" stroke-width="1.5"/></svg>
                </div>
                <div class="flex-grow">
